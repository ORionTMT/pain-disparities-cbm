...
if getpass.getuser() == 'emmap1':
    ...
    INDIVIDUAL_IMAGES_PATH = '/home/jacktongmt/pain-disparities-cbm/processed_data_48m' # points to the directory which stores the processed data, so you should download the processed data into this folder. If you are reprocessing the raw data, the individual images will be stored in this folder. 
    ...
    BASE_IMAGE_DATA_DIR = '/home/jacktongmt/NDA/nda-tools/downloadcmd/packages/113486' # Set this path to point to the directory where you downloaded the IMAGE OAI data - eg, it should contain folders like "00m" for each timepoint. 
